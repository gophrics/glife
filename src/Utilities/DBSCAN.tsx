...
constructor(dataset: Array<ClusterModal>, epsilon: number, minPts: number, distanceFunction: (p: any, q: any) => number) {
 ...
 Run = (dataset: Array<ClusterModal>, epsilon: number, minPts: number, distanceFunction: (p: any, q: any) => number) => {
   ...
   * @access protected
   */
 _init = (dataset: Array<any>, epsilon: number, minPts: number, distance: (p: any, q : any) => number) => {
   ...
   * @access protected
   */
  _mergeArrays = function(a: Array<any>, b: Array<any>) {
    var len = b.length;
   ...
   * @access protected
   */
  _euclideanDistance = function(p: any, q: any) {
    var sum = 0;
